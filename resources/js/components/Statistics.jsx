...
export const statisticsData = {
    ...
    'MCS (AC)': {
        sem1: [
            { label: 'All Students', value: 65, icon: faUser, change: '-' },
            { label: 'Active Students', value: 18, icon: faSmile, change: '-10', changeColor: 'red' },
            { label: 'GoT Students', value: 47, icon: faGraduationCap, change: '+10', changeColor: 'green' },
            { label: 'Supervisors', value: 20, icon: faBriefcase, change: '-' },
            { label: 'Dissertations', value: 30, icon: faFileAlt, change: '+10', changeColor: 'green' },
        ],
        sem2: [
            { label: 'All Students', value: 68, icon: faUser, change: '-' },
            { label: 'Active Students', value: 20, icon: faSmile, change: '-8', changeColor: 'red' },
            { label: 'GoT Students', value: 48, icon: faGraduationCap, change: '+12', changeColor: 'green' },
            { label: 'Supervisors', value: 22, icon: faBriefcase, change: '-' },
            { label: 'Dissertations', value: 35, icon: faFileAlt, change: '+12', changeColor: 'green' },
        ],
        sem3: [
            { label: 'All Students', value: 77, icon: faUser, change: '-' },
            { label: 'Active Students', value: 19, icon: faSmile, change: '-9', changeColor: 'red' },
...
function Statistics({ selectedSemester, selectedProgram }) {
    const statsData = {
        'MSE (ST)': {
            sem1: [
                { label: 'All Students', value: 77, icon: faUser, change: '-' },
    ...
    const stats = statsData[selectedProgram]?.[selectedSemester] || [];
